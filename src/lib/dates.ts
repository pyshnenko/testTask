const libDatesPage1: [number, string][] = [
  ...
  [
    1982,
    'Появился компьютер... текст на видео частично скрыт'
  ],
  [
    1989,
...
const libDatesPage3: [number, string][] = [
  ...
  [
    1997,
    '"Гарри Поттер " и дальше в демо-файле не видно, но взять надо там'
  ]
];
...
const libDatesPage4: [number, string][] = [
  ...
  [
    2003,
    'В Венеции что-то произошло, что не читаемо в демо-файле'
  ]
];
...
const libDatesPage5: [number, string][] = [
  ...
  [
    2010,
    '13-28 февраляв Ванкувере: Зимние игры 2010 года.'
  ],
  [
    2012,
...
const libDatesPage6: [number, string][] = [
  ...
  [
    2020,
    'Корабль Crew Dragon вернулся из первого пилотируемого полёта'
  ],
  [
    2021,
    'Тут явно что-то есть но в демо-файле не видно'
  ]
];
